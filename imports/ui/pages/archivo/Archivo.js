...
const regEntradaBodyTemplate = (rowData) => {
  return (
      <React.Fragment>
          <span className="p-column-title">Registro de Entrada</span>
          {rowData.regEntrada}
      </React.Fragment>
  );
}
  const regSalidaBodyTemplate = (rowData) => {
    return (
        <React.Fragment>
            <span className="p-column-title">Registro de Salida</span>
            {rowData.regSalida}
        </React.Fragment>
    );
}
const estanteBodyTemplate = (rowData) => {
  return (
      <React.Fragment>
          <span className="p-column-title">Estante</span>
          {rowData.estante}
      </React.Fragment>
  );
}
...
const statuses = [
    {label: 'Clasificado', value: 'true'},
    {label: 'No Clasificado', value: 'false'}
];
...
const statusItemTemplate = (option) => {
  return <span className={`customer-badge status-${option.value}`}>{option.label}</span>;
}
